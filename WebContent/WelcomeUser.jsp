...
<div class="fh5co-loader"></div>
						...
						<ul>
							...
							<!-- <li><a href="courses.html">Courses</a> -->
								<li class="has-dropdown"><a href="courses.html">Courses</a>
									<ul class="dropdown">
											<li><a href="Courses-PDF/JavaTheCompleteReference.pdf">Java</a></li>
											<li><a href="Courses-PDF/C++.pdf">C++</a></li>
											<li><a href="Courses-PDF/python.pdf">Python</a></li>
										</ul>
										</li>
							...
							<li class="btn-cta" ><a href="index.html"><span>logout</span></a></li>
					
 							
  									
  									 <h3><font face = "Times New Roman" size = "4"><%String name=request.getParameter("name"); %><br>
  									 welcome <%=name %></font></h3>
			   			...
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>The Roots of Education are Bitter, But the Fruit is Sweet</h1>
									<h2><a href="" target="_blank">Tutorial</a></h2>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="Courses-PDF/JavaTheCompleteReference.pdf" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="#" class="course-img" style="background-image: url(pics/10.jpg);">
						</a>
						<div class="desc">
							<h3><a href="#">C++</a></h3>
							...
							<span><a href="Courses-PDF/C++.pdf" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="Courses-pdf/python.pdf" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="Courses-PDF/web_technology.pdf" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
			</div>
	...
	<div id="fh5co-gallery" class="fh5co-bg-section">
		<div class="row text-center">
			<h2><span>Our Tuto Gallery</span></h2>
		</div>
		<div class="row">
			<div class="col-md-3 col-padded">
				<a href="#" class="gallery" style="background-image: url(pics/17.jpg);"></a>
			</div>
			<div class="col-md-3 col-padded">
				<a href="#" class="gallery" style="background-image: url(pics/16.jpg);"></a>
			</div>
			<div class="col-md-3 col-padded">
				<a href="#" class="gallery" style="background-image: url(pics/18.jpg);"></a>
			</div>
			<div class="col-md-3 col-padded">
				<a href="#" class="gallery" style="background-image: url(pics/19.jpg);"></a>
			</div>
		</div>
	</div>
<br>
